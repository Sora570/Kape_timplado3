...
CREATE TABLE `inventory` (
  ...
  `maxStock` int(11) NOT NULL DEFAULT 100,
...
CREATE TABLE `products` (
  ...
  `image_url` varchar(255) DEFAULT 'assest/image/no-image.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `products` (`productID`, `productName`, `categoryID`, `isActive`, `createdAt`, `unit_type`, `unit_value`, `base_price`, `cost_price`, `is_trackable`, `min_stock_level`, `max_stock_level`, `supplier_info`, `barcode`, `sku`, `image_url`) VALUES
(1, 'Caramel Macchiato', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(2, 'Cinnamon Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(3, 'Coconut Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(4, 'Sea Salt Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(5, 'Spanish Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(6, 'Hazelnut Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(7, 'Mocha Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(8, 'Dirty Matcha', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(9, 'Dulca de Leche Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(10, 'Salted Caramel Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(11, 'White Mocha Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(12, 'Cafe Latte', 1, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(13, 'Matcha', 2, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(14, 'Cookies & Cream', 2, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(15, 'Milo Overload', 2, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(16, 'Red Velvet', 2, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(17, 'Coconut Matcha', 2, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(18, 'Berry Cheesecake', 3, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(19, 'Matcha Cheesecake', 3, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(20, 'Oreo Cheesecake', 3, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(21, 'Ube Cheesecake', 3, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(22, 'Red Velvet Cheesecake', 3, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(23, 'Strawberry Milk', 4, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(24, 'Berry Matcha', 4, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(25, 'Berry Oreo', 4, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(26, 'Berry Choco', 4, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(27, 'Creamy Ube', 5, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(28, 'Ube Latte', 5, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(29, 'Ube Matcha', 5, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(30, 'Ube Macapuno', 5, 1, '2025-09-08 16:06:13', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(37, 'Berry Cafe', 4, 1, '2025-09-19 14:45:59', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(38, 'Berry Latte', 4, 1, '2025-09-19 14:52:03', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(42, 'Berry Juice', 4, 1, '2025-09-24 14:23:19', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(43, 'blueberry', 4, 1, '2025-09-24 15:07:23', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png'),
(44, 'Black Berry', 4, 1, '2025-09-28 09:15:17', 'piece', 1.00, 0.00, 0.00, 1, 0, 1000, NULL, NULL, NULL, 'assest/image/no-image.png');
...
--
-- Table structure for table `product_addon_relationships`
--
...
(11, 'Piece', 'pc', 1.0000, 1, '2025-10-16 17:22:39'),
(12, 'Ounce', 'oz', 1.0000, 1, '2025-10-16 17:22:39'),
(13, 'Pound', 'lb', 16.0000, 0, '2025-10-16 17:22:39'),
(14, 'Kilogram', 'kg', 35.2740, 0, '2025-10-16 17:22:39'),
(15, 'Gram', 'g', 0.0353, 0, '2025-10-16 17:22:39'),
(16, 'Liter', 'L', 33.8140, 0, '2025-10-16 17:22:39'),
(17, 'Milliliter', 'mL', 0.0338, 0, '2025-10-16 17:22:39'),
(18, 'Cup', 'cup', 8.0000, 0, '2025-10-16 17:22:39'),
(19, 'Tablespoon', 'tbsp', 0.5000, 0, '2025-10-16 17:22:39'),
(20, 'Teaspoon', 'tsp', 0.1667, 0, '2025-10-16 17:22:39');
...
ALTER TABLE `inventory`
  ...
  ADD UNIQUE KEY `unique_product_size` (`productID`,`sizeID`),
  ADD KEY `idx_product` (`productID`),
  ADD KEY `idx_size` (`sizeID`),
  ADD KEY `idx_stock` (`currentStock`);
...
--
-- Indexes for table `product_addon_relationships`
--
ALTER TABLE `product_addon_relationships`
...
--
-- AUTO_INCREMENT for table `product_addon_relationships`
--
ALTER TABLE `product_addon_relationships`
...
--
ALTER TABLE `inventory`
  ADD CONSTRAINT `fk_inventory_products` FOREIGN KEY (`productID`) REFERENCES `products` (`productID`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_inventory_sizes` FOREIGN KEY (`sizeID`) REFERENCES `sizes` (`sizeID`) ON DELETE CASCADE;

--
-- Constraints for table `inventory_history`
--
ALTER TABLE `inventory_history`
  ADD CONSTRAINT `fk_inventory_history` FOREIGN KEY (`inventoryID`) REFERENCES `inventory` (`inventoryID`) ON DELETE CASCADE;

--
-- Constraints for table `inventory_transactions`
--
ALTER TABLE `inventory_transactions`
  ADD CONSTRAINT `inventory_transactions_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`productID`) ON DELETE CASCADE,
  ADD CONSTRAINT `inventory_transactions_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`userID`) ON DELETE SET NULL;
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`userID`) REFERENCES `users` (`userID`) ON DELETE SET NULL;
...
--
-- Constraints for table `product_addon_relationships`
--
ALTER TABLE `product_addon_relationships`
  ADD CONSTRAINT `product_addon_relationships_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`productID`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_addon_relationships_ibfk_2` FOREIGN KEY (`addon_id`) REFERENCES `product_addons` (`addon_id`) ON DELETE CASCADE;

--
-- Constraints for table `product_inventory`
--
ALTER TABLE `product_inventory`
  ADD CONSTRAINT `product_inventory_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`productID`) ON DELETE CASCADE;

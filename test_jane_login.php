...
$stmt = $conn->prepare("SELECT userID, username, role, pin_hash, employee_id FROM users WHERE employee_id = ? AND is_active = 1");
...
if ($result && $result->num_rows > 0) {
    ...
    echo "No user found for employee_id: $employeeId\n";
}

...
<body class="<?php echo ($_SESSION['role'] === 'cashier') ? 'cashier-mode' : ''; ?>">
    <div id="container" class="container">
        ...
        <div class="main">
            ...
            <!-- ------------------ Orders Tab ------------------ -->
            <section id="OrdersForm" style="display:none;">
                <?php if ($_SESSION['role'] === 'admin'): ?>
                ...
                <?php else: ?>
                <!-- Cashier Orders: POS Recent orders -->
                <div class="pos-orders-root">
                    <div class="pos-orders-header">
                        <h1 class="orders-title">Recent Orders</h1>
                        <div class="pos-summary">
                            <div class="pos-summary-card">
                                <h3>Total Items Today</h3>
                                <span id="todayItemsCount">0</span>
                            </div>
                            <div class="pos-summary-card">
                                <h3>Total Sales Today</h3>
                                <span id="todaySalesTotal">₱0.00</span>
                            </div>
                        </div>
                    </div>
                    
                    <div class="pos-orders-content">
                        <div class="pos-orders-filters">
                            <input type="text" id="posOrderSearch" placeholder="Search recent orders..." class="search-input">
                            <select id="posOrderStatusFilter" class="filter-select">
                        ...
                        <div class="pos-orders-list" id="posOrdersList">
            ...
            <!-- ------------------ Pending Orders Tab ------------------ -->
            <section id="PendingOrdersForm" style="display:none;">
                <div class="orders-root">
                    <div class="orders-header">
                        <h1 class="orders-title">Pending Orders</h1>
            ...
            <section id="CompletedOrdersForm" style="display:none;">
                <div class="orders-root">
                    <div class="orders-header">
                        <h1 class="orders-title">Completed Orders</h1>

                    </div>
                    <div class="orders-content">
                        <div class="orders-filters">
                            <input type="text" id="completedOrderSearch" placeholder="Search completed orders..." class="search-input">
                            <input type="date" id="completedOrderDate" class="filter-select">
                        </div>
                        <div class="orders-table-container">
                            <table class="orders-table">
                                <thead>
                ...
                <div class="transactions-root">
                    ...
                    <div class="transactions-filters">
                        <div class="filter-row">
                            ...
                            <input type="text" id="transactionSearch" placeholder="Search by transaction ID or customer..." class="filter-input">
                        </div>
                    </div>
            ...
            <section id="SettingsForm" style="display:none;">
                <div class="settings-root">
                    ...
                    <div class="settings-content">
                        <!-- General Settings (Direct Display) -->
                        <div id="settings-general" class="settings-content-section">
                            <div class="settings-grid">
                                ...
                                <div class="settings-section">
                                    ...
                                    <div class="config-item">
                                        ...
                                        <input type="text" id="companyName" placeholder="Kape Timplado's" value="Kape Timplado's">
                                    </div>
                                    <div class="config-item">
                                        <label for="systemLocation">Location:</label>
                                        <div class="location-input-group">
                                            <input type="text" id="systemLocation" placeholder="Main Branch">
                                ...
                                <div class="settings-section">
                                    ...
                                    <div class="config-item">
                                        <label for="printCopies">Print Copies:</label>
                                        <input type="number" id="printCopies" min="1" max="3" value="1">
                                    </div>
                </div>
                                ...
                                <div class="settings-section">
                                    ...
                                    <div class="config-item">
                                        ...
                                        <input type="text" id="receiptHeader" placeholder="Thank you for your business!">
                                    </div>
                                    <div class="config-item">
                                        <label for="receiptFooter">Receipt Footer:</label>
                                        <textarea id="receiptFooter" rows="3" placeholder="Visit us again soon!"></textarea>
                                    </div>
                                    <div class="config-item">
                                        <label for="receiptLogo">Receipt Logo:</label>
                                        <div class="logo-upload-group">
                                            <input type="file" id="receiptLogo" accept="image/*">
                                            <button type="button" class="btn-secondary" onclick="useDefaultLogo()">Use Default Logo</button>
                                        </div>
                                        <small>Current logo: <img src="assest/image/logo.png" alt="Logo" style="height: 20px; vertical-align: middle;"></small>
                    </div>
                </div>

                                <!-- Save Settings -->
                                <div class="settings-actions">
                                    <button type="button" class="btn-primary" onclick="saveGeneralSettings()">
                                        <ion-icon name="save-outline"></ion-icon>
                                        Save Settings
                                    </button>
                                    <button type="button" class="btn-secondary" onclick="resetGeneralSettings()">

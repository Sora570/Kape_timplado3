            ...
            <tr>
                <td>
                    <div class="product-image-small">
                        ${product.image_url ?
                            `<img src="${product.image_url}" alt="${product.productName || 'Unknown Product'}" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" style="width: 40px; height: 40px; object-fit: cover; border-radius: 4px;">` :
                            ''
                        }
                        <div style="display: ${product.image_url ? 'none' : 'flex'}; width: 40px; height: 40px; background: #f5f5f5; border-radius: 4px; align-items: center; justify-content: center; font-size: 12px; color: #999;">📦</div>
                    </div>
                </td>
                <td>
